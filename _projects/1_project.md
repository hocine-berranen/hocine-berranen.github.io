...
description: "A modular C application for reading, validating, analyzing, and visualizing time series data.<br><br><strong>Tools:</strong> C, Makefile, GitLab, Libtap, JSON, Gnuplot, Bats."
